...
{%- if site.includes_r contains site.workshop_content %}
...
* Once you have been given your username and password, **[follow these instructions](../software-setup/rstudio-login.md)** to log in to our RStudio server.
